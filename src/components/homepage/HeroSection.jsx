    ...
    <div className="space-y-8 text-center lg:text-left">
      ...
      <div className="max-w-4xl space-y-4">
        ...
        <p className="max-w-3xl text-lg leading-9 text-slate-600">
          Theo dõi đơn hàng mới, kiểm tra prescription, hỗ trợ khách hàng và phối hợp với
          các bộ phận chuyên trách trong một không gian làm việc tập trung.
        </p>
      </div>
  ...
  return (
    <div className="space-y-8 text-center lg:text-left">
      ...
      <p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-600 lg:mx-0">
        Mua kính nhanh chóng, đặt trước tiện lợi và cá nhân hóa theo nhu cầu. Trải nghiệm
        dịch vụ chăm sóc mắt chuyên nghiệp và tận tâm.
      </p>
