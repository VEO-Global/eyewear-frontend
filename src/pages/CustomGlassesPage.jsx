                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-slate-600">
                        Người dùng sẽ nhìn thấy tên tròng kính để dễ chọn. Hệ
                        thống vẫn lưu lại `id` của lens ở nền.
                      </p>
                    </div>
                  </div>
              ...
              <div className="grid gap-6 lg:grid-cols-[1.04fr_0.96fr]">
                ...
                <div className="h-fit rounded-[28px] border border-slate-900 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-4 text-sm leading-6 text-slate-500">
                    Nếu bạn chưa chọn tròng kính, EyeCare sẽ xác nhận chi phí
                    hoàn thiện sau khi tiếp nhận yêu cầu của bạn.
                  </p>
